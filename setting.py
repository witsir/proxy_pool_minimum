...
CYCLE_TESTER = env.int('CYCLE_TESTER', 40)
# definition of getter cycle, it will get proxy every CYCLE_GETTER second
CYCLE_GETTER = env.int('CYCLE_GETTER', 10000)
...
ENABLE_LOG = env.bool('ENABLE_LOG', True)
ENABLE_LOG_CONSOLE = env.bool('ENABLE_LOG_CONSOLE', True)
ENABLE_LOG_FILE = env.bool('ENABLE_LOG_FILE', True)
ENABLE_LOG_RUNTIME_FILE = env.bool('ENABLE_LOG_RUNTIME_FILE', True)
ENABLE_LOG_ERROR_FILE = env.bool('ENABLE_LOG_ERROR_FILE', False)
...
# log level
LOG_LEVEL = env.str('LOG_LEVEL', LOG_LEVEL_MAP.get(APP_ENV, 'DEBUG'))
